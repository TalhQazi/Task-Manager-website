      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="space-y-1">
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold tracking-tight flex items-center gap-2">
            ...
            Bug Reports & Verification
          </h1>
          <p className="text-xs sm:text-sm text-muted-foreground">
            Report issues, track fix progress, and verify resolutions.
          </p>
        </div>
        ...
        <CardContent className="p-3 sm:p-4 flex flex-col sm:flex-row gap-3 sm:items-center justify-between">
          ...
          <Select value={statusFilter} onValueChange={setStatusFilter}>
            ...
            <SelectContent>
              ...
              <SelectItem value="open">Open Bugs</SelectItem>
              <SelectItem value="AWAITING_REPORTER_CONFIRMATION">Awaiting Verification</SelectItem>
            ...
            <div className="w-full overflow-x-auto">
              <Table>
                ...
                <TableBody>
                  ...
                  {filtered.length === 0 && (
                    <TableRow>
                      <TableCell colSpan={4} className="text-center py-12 text-muted-foreground text-xs italic">
                        No bugs found.
                      </TableCell>
                    </TableRow>
                  )}
