          ...
          >
            {/* LEFT SIDE: Branding and Profile Stacking */}
              ...
              <div className="flex flex-wrap items-center gap-2 sm:gap-4">
                <button type="button" className="group inline-flex md:hidden h-9 w-9 items-center justify-center rounded-full bg-white/10 hover:bg-white/[0.14] hover:shadow-[0_1px_2px_rgba(0,0,0,0.1)] transition-all duration-100 linear mr-2" aria-label="Open navigation" onClick={() => onMenuClick?.()}><Menu className="h-5 w-5 text-white group-hover:brightness-[110%] transition-all duration-100 linear drop-shadow-sm" /></button>
              </div>
            </div>
          </div>
        </div>
